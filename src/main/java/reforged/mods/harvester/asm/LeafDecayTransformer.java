...
public class LeafDecayTransformer implements IClassTransformer {
    ...
    public byte[] transform(String obfName, String transformedName, byte[] basicClass) {
        return obfName.equals("api") ? transform(basicClass) : basicClass;
    }
    ...
    private byte[] transform(byte[] basicClass) {
        ...
        MethodVisitor methodVisitor = writer.visitMethod(Opcodes.ACC_PUBLIC, "a", "(Laab;IIII)V", null, null);
        ...
        methodVisitor.visitMethodInsn(Opcodes.INVOKESTATIC, "reforged/mods/harvester/asm/LeafDecayHandler", "handleLeafDecay", "(Laab;III)V");
        Label label0 = new Label();
        methodVisitor.visitLabel(label0);
        methodVisitor.visitLineNumber(642, label0);
